...
vim.keymap.set('n', ']c', '<Cmd>execute &diff ? "normal! ]c" : "Gitsigns nav_hunk next"<CR>', { desc = 'Jump to next unstaged git hunk' })
vim.keymap.set('n', '[c', '<Cmd>execute &diff ? "normal! [c" : "Gitsigns nav_hunk prev"<CR>', { desc = 'Jump to previous unstaged git hunk' })
vim.keymap.set('n', ']C', '<Cmd>Gitsigns nav_hunk next --target=all<CR>', { desc = 'Jump to next git hunk' })
vim.keymap.set('n', '[C', '<Cmd>Gitsigns nav_hunk prev --target=all<CR>', { desc = 'Jump to previous git hunk' })
