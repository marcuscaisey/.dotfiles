...
end, { desc = [[nvim-treesitter-textobjects.move.goto_next_start('@method.outer', 'textobjects')]] })
vim.keymap.set({ 'n', 'x', 'o' }, ']F', function()
  move.goto_next_end('@function.outer', 'textobjects')
end, { desc = [[nvim-treesitter-textobjects.move.goto_next_end('@function.outer', 'textobjects')]] })
vim.keymap.set({ 'n', 'x', 'o' }, ']M', function()
  move.goto_next_end('@method.outer', 'textobjects')
end, { desc = [[nvim-treesitter-textobjects.move.goto_next_end('@method.outer', 'textobjects')]] })
vim.keymap.set({ 'n', 'x', 'o' }, '[f', function()
...
end, { desc = [[nvim-treesitter-textobjects.move.goto_previous_start('@method.outer', 'textobjects')]] })
vim.keymap.set({ 'n', 'x', 'o' }, '[F', function()
  move.goto_previous_end('@function.outer', 'textobjects')
end, { desc = [[nvim-treesitter-textobjects.move.goto_previous_end('@function.outer', 'textobjects')]] })
vim.keymap.set({ 'n', 'x', 'o' }, '[M', function()
  move.goto_previous_end('@method.outer', 'textobjects')
end, { desc = [[nvim-treesitter-textobjects.move.goto_previous_end('@method.outer', 'textobjects')]] })
